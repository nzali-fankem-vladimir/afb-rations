...
- **Workflow (6)** : `/processus` (POST), `/processus/{id}`, `/processus/{id}/etat`, `/processus/{id}/soumission`, `/processus/{id}/validation`, `/processus/{id}/retour`. Les trois premiers sont livrés (Sprint 4.1) ; les trois derniers relèvent des Sprints 4.2 à 4.4. Deux codes d'erreur ajoutés au contrat au Sprint 4.1 : `PROCESSUS_EXISTANT` (409) et `FONCTIONNALITE_NON_OUVERTE` (422).
