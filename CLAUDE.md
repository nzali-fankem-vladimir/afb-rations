...
**Une réponse `200` atteste que le broker a accusé réception, et rien de moins.** C'est elle, et elle seule, qui autorise le service Workflow à poser `transmis_comptabilite` (RG-13). Le poser sans cette certitude figerait un état réputé transmis et jamais payé, que le contrôle d'unicité refuserait ensuite comme un doublon.
...
- **Poser `transmis_comptabilite` à la clôture** : il est posé à la **publication effective**, après accusé du broker (RG-13, Sprint 5.1), et sur les **deux** branches du seuil. Le poser plus tôt figerait un état réputé transmis et jamais payé.
