 ...
 * (Sprint 6.1).
 *
 * <p>Pendant de {@link HabilitationService} pour la recherche : celui-ci demande
 ...
 * recherche inforgeable : un appel direct sur le port 8084 ne peut pas s'attribuer
