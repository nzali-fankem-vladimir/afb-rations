 ...
 *
 * <p><b>Tolerant reader</b>, comme {@link HabilitationReponse} : le service Identite
 ...
 *
 * <p>Une classe a part plutot qu'un enrichissement de {@link HabilitationReponse} :
 * celle-ci porte le verdict d'une question fermee — « cette personne peut-elle agir
 * sur l'unite X » —, celle-ci l'ensemble des unites visibles. Deux questions, deux
 * lectures, aucune ambiguite a l'usage.
 *
 */
