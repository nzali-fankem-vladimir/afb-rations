...
import cm.afrilandfirstbank.rations.saisie.application.PorteeAccesUtilisateur;
import cm.afrilandfirstbank.rations.saisie.application.PorteeClient;
import cm.afrilandfirstbank.rations.saisie.application.ResultatPortee;
...
import cm.afrilandfirstbank.rations.saisie.infrastructure.identite.PorteeReponse.PorteeAccesReponse;

/**
 * Lit {@code porteeAcces} sur {@code GET /identite/moi} (Sprint 6.1).
 *
 * <p>Meme facture que {@link HabilitationHttpClient} :
...
public class PorteeHttpClient implements PorteeClient {
     ...
     *
     * <p>C'est la meme discipline que {@code HabilitationHttpClient} : un champ absent ne
