...
class FicheJournaliereRepositoryTest {
    ...
    void rechercheParProcessusEtDate_retrouveLaBonneFiche() {
        repository.saveAndFlush(new FicheJournaliere(ID_PROCESSUS, LocalDate.of(2026, 8, 15), "00002", LocalDate.of(2026, 8, 1), LocalDate.of(2026, 8, 31)));
        repository.saveAndFlush(new FicheJournaliere(ID_PROCESSUS, LocalDate.of(2026, 8, 16), "00002", LocalDate.of(2026, 8, 1), LocalDate.of(2026, 8, 31)));
